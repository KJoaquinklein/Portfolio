        ...
        <div id="proyect" className="bg-black-0 mv:pb-5 md:pb-40 max-w-screen font-port flex justify-center ">
            <div className="pt-5 mv:w-screen sm:w-2/3 flex flex-col">
                ...
                <div className="flex justify-center flex-wrap mv:space-y-6 xl:space-y-0">
                    {/* OPEN BOOK */}
                    <div className="relative inline-flex overflow-hidden p-[2px] min-h-[402px] mv:min-w-[386px] sm:min-w-[426px] mx-5 border-2 border-orange-0">
                        <div className="text-white-0 flex flex-col items-center justify-between bg-black-0 px-4 pt-4 pb-3">
                                    ...
                                    {showMorOpenBook ? (
                                        <div>
                                            <p className="text-wrap w-96 mv:pr-6 sm:pr-0 text-sm">
                                                Ecommerce para la venta de libros en el que participe como desarrollador
                                                FrontEnd, utilizando tecnologías como React.js, Redux y Tailwind css.
                                                También desarrolle el chat en vivo llamado "OpenBook Community", donde
                                                aporte al BackEnd con Socket.io.
                                            </p>
                                            <button
                                    ...
                                    {showMorCountry ? (
                                        <div>
                                            <p className="text-wrap w-96 mv:pr-6 sm:pr-0 text-sm">
                                                ...
                                                paises. También podemos filtrar, ordenar los paises o buscarlo por su
                                                nombre.
                                            </p>
                                            <button
                                                className="underline hover:text-orange-0 duration-300 text-sm"
